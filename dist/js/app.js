...
document.addEventListener('DOMContentLoaded', () => {
	...
	$(".close").click(function(){
		...
		$(".offer__menu__hach").click(function(){
		$(".advancingMenu").addClass("none");
		$(".offer__menu__hach").addClass("none");
		$(".offer__mobile__menu").addClass("dblock");
		$(".offer__limiter__offerimg").removeClass("none");
		});
